...
namespace CodeTur.Testes.Repositorios
{
    public class FakeUsuarioRepositorio : IUsuarioRepositorio
    {
        List<Usuario> _usuarios = new List<Usuario>()
            {
                new Usuario("Cauê", "caue.sacchitiello@email.com", "1234567", Comum.Enum.EnTipoUsuario.Comum),
                new Usuario("Cauã", "caua.sacchitiello@email.com", "1234567", Comum.Enum.EnTipoUsuario.Comum)
            };
